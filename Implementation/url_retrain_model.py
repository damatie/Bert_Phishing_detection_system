...
# url_retrain_model.py
# Code with 24hr retraining and stat
import torch
...
# Define your custom text input preparation for URL features
...
# Function to evaluate production model
def evaluate_production_model(train_dataloader):
    production_model_path = 'models/url/best_model.pth'
...
def retrain_model():
    ...
    # Load the model
    model_path = 'models/url/best_model.pth'
    ...
    save_path = os.path.join("models", "url", "latest_retrained_model.pth")
    torch.save(model.state_dict(), save_path)
    tokenizer.save_pretrained(os.path.join("models", "url"))
